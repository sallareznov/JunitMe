...
public class MessageEndpointFactoryKeyFactoryImpl implements
		MessageEndpointFactoryKeyFactory {
	private final static MessageEndpointFactoryKeyFactory INSTANCE = new MessageEndpointFactoryKeyFactoryImpl();

	public static MessageEndpointFactoryKeyFactory instance() {
		return INSTANCE;
	}

	private MessageEndpointFactoryKeyFactoryImpl() {
	}

	public MessageEndpointFactoryKey createMessageEndpointKey(
			final ActivationSpec activationSpec,
			final MessageEndpointFactory messageEndpointFactory) {
		return new MessageEndpointFactoryKeyImpl(activationSpec,
